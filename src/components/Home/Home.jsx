...
const Home = () => {
    ...
    return (
        <div>
            ...
            <h1 className="text-center text-4xl font-bold pt-10">Popular <span className="text-black">Services</span></h1>
            ...
            <div>
                <p className="px-8"><Link className="" to='/services'><button className='btn bg-black text-white border-none btn-md px-5 flex justify-center items-center mx-auto'>Show All</button></Link></p>
            </div>
            <Gallery></Gallery>
            <Support></Support>
