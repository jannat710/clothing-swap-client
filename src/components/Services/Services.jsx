    ...
    return (
        <div>
            ...
            <div className="font-semibold text-3xl mx-20">
                <h3 className="text-[#D11752] py-10 text-sm md:text-xl lg:text-3xl  uppercase divider divider-neutral"><span className="px-10">Services</span></h3>
            </div>
                            ...
                            <div className="rounded-lg flex justify-center items-center bg-base-100 shadow-xl w-full mx-auto h-72 border">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="card-actions justify-end">
                                        <button className="btn border-none rounded-sm ml-2 bg-[#D11752] text-white">View Detail</button>
                                    </div>
                                </div>
                            </div>
                        </div>
